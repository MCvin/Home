...
if [ "$color_prompt" = yes ]; then
    ...
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;36m\][\!] \A \h\[\033[00m\]:\[\033[01;37m\]\w\[\033[00m\] > '
else
...
source /usr/share/geant4/geant4.10.03.p01-install/bin/geant4.sh
...
alias log='echo $(date +%Y-%m-%d): >> $CRCT/logbook/$(date +%Y-%m).log; vi +10000 $CRCT/logbook/$(date +%Y-%m).log'
